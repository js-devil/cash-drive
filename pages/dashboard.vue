        ...
        <div class="col-lg-4 col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <div
                class="net-income mt-4 position-relative"
                style="height: 294px"
              ></div>
            ...
            <div class="card-body">
              ...
              <div class="row mb-3 align-items-center mt-1 mt-5">
                ...
                <div class="col-3 text-right">
                  <span class="mb-0 font-14 text-dark font-weight-medium"
                    >28%</span
                  >
                </div>
              </div>
        ...
        <div class="col-md-6 col-lg-8">
          <div class="card">
            <div class="card-body">
              ...
              <div class="pl-4 mb-5">
                <div
                  class="stats ct-charts position-relative"
                  style="height: 315px"
                ></div>
              </div>
                    ...
                    <tr>
                      <td class="border-top-0 px-2 py-4">
                        <div class="d-flex no-block align-items-center">
                          <div class="mr-3">
                            <img
                              src="/img/users/widget-table-pic1.jpg"
                              alt="user"
                    ...
                    <tr>
                      <td class="px-2 py-4">
                        <div class="d-flex no-block align-items-center">
                          <div class="mr-3">
                            <img
                              src="/img/users/widget-table-pic2.jpg"
                              alt="user"
                              class="rounded-circle"
                              width="45"
                              height="45"
                    ...
                    <tr>
                      <td class="px-2 py-4">
                        <div class="d-flex no-block align-items-center">
                          <div class="mr-3">
                            <img
                              src="/img/users/widget-table-pic3.jpg"
                              alt="user"
                              class="rounded-circle"
                              width="45"
                              height="45"
                    ...
                    <tr>
                      <td class="px-2 py-4">
                        <div class="d-flex no-block align-items-center">
                          <div class="mr-3">
                            <img
                              src="/img/users/widget-table-pic4.jpg"
                              alt="user"
                              class="rounded-circle"
                              width="45"
                              height="45"
